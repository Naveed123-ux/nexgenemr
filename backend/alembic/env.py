...
# Import your Base from your db setup
from db.db import Base
# Import all your models here so that Alembic knows about them
...
from models.prescription_model import Prescription # 👈 ADD THIS LINE
...
# This is the MetaData object which contains all of the
# table definitions.
