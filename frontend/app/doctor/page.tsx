...
import PatientCards from "@/components/PatientCards"; // <-- IMPORTED NEW COMPONENT
...
const EmptyState = () => (
  <div className="text-center py-10 text-gray-500">
    <p>No Tracker Dashboard found.</p>
  </div>
);
...
export default function PatientsDashboard() {
  ...
  const renderContent = () => {
    ...
    return <PatientTable link="doctor/patient-stats" data={patients} columns={columns} />;
  };
